...
if [ "$USER" != "atlassian" ]; then
  echo "This script must run as atlassian user, not as $USER."
  exit 1
fi


NAME=crowdRegister
NODE_BIN_DIR=/home/atlassian/node/bin
NODE_PATH=/home/atlassian/node/lib/node_modules
APPLICATION_DIRECTORY=/home/atlassian/crowdRegister/dist
APPLICATION_START=server.js
PIDFILE=/home/atlassian/crowdRegister/app.pid
LOGFILE=/home/atlassian/crowdRegister/output.log
...
start() {
    ...
    # running.
    NODE_ENV=production forever --pidFile $PIDFILE --sourceDir $APPLICATION_DIRECTORY \
